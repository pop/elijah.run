...
Basically, what if I am *picky* and want the *flexibility* of struct
...
Unfortunately we can't do anything like `#[derive(From<UiColor>)]`
...
Rust can sprinkle magic on your code, but you have to explicitly call
